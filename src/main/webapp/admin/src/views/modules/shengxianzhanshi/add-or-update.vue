          ...
          <el-form-item class="input" label="数量" prop="shuliang">
              <el-input v-model="ruleForm.shuliang" 
                placeholder="数量" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="进货价格" prop="jinhuojiage">
          <el-input v-model="ruleForm.jinhuojiage" 
              placeholder="进货价格" clearable  :readonly="ro.jinhuojiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="进货价格" prop="jinhuojiage">
              <el-input v-model="ruleForm.jinhuojiage" 
                placeholder="进货价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shengxianzhanshi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shengxianzhanshiCrossAddOrUpdateFlag = false;
                  this.parent.search();
