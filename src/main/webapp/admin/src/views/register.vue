  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(30, 136, 229, 1);fontSize:28px;">生鲜供应平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="账号" class="input" v-if="tableName=='gongyingshang'">
			...
			<el-form-item label="供应商名称" class="input" v-if="tableName=='gongyingshang'">
			  <el-input v-model="ruleForm.gongyingshangmingcheng" autocomplete="off" placeholder="供应商名称" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='gongyingshang'" class="input-group">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='gongyingshang'">
